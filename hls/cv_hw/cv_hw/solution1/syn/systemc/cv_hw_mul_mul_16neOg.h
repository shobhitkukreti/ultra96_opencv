...
#ifndef __cv_hw_mul_mul_16neOg__HH__
#define __cv_hw_mul_mul_16neOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cv_hw_mul_mul_16neOg) {
    ...
    SC_CTOR(cv_hw_mul_mul_16neOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
