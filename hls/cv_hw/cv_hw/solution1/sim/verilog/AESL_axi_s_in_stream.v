...
module AESL_axi_s_in_stream (
    ...
    fifo #(307200, 32) fifo_in_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(307200, 4) fifo_in_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(307200, 4) fifo_in_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(307200, 1) fifo_in_stream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(307200, 1) fifo_in_stream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(307200, 1) fifo_in_stream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(307200, 1) fifo_in_stream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
