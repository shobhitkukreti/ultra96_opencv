...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name cv_hw_ap_dmul_3_max_dsp_64
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name cv_hw_ap_dmul_3_max_dsp_64 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips cv_hw_ap_dmul_3_max_dsp_64] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files cv_hw_ap_dmul_3_max_dsp_64.xci]
generate_target {synthesis simulation} [get_files cv_hw_ap_dmul_3_max_dsp_64.xci]
