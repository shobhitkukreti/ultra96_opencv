...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 11 \
			corename cv_hw_CTRL_BUS_axilite \
			name cv_hw_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cv_hw_CTRL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 19 \
    name op_stream_V_data_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TDATA { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 20 \
    name op_stream_V_keep_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TKEEP { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_keep_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 21 \
    name op_stream_V_strb_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TSTRB { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_strb_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 22 \
    name op_stream_V_user_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TUSER { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 23 \
    name op_stream_V_last_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TLAST { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_last_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 24 \
    name op_stream_V_id_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TID { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_id_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 25 \
    name op_stream_V_dest_V \
    reset_level 0 \
    sync_rst true \
    corename {op_stream} \
    metadata {  } \
    op interface \
    ports { op_stream_TVALID { O 1 bit } op_stream_TREADY { I 1 bit } op_stream_TDEST { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'op_stream_V_dest_V'"
}
}
