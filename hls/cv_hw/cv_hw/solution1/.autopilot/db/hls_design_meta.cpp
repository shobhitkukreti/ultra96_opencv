...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("op_stream_TDATA", 32, hls_out, 7, "axis", "out_data", 1),
	Port_Property("op_stream_TVALID", 1, hls_out, 13, "axis", "out_vld", 1),
	Port_Property("op_stream_TREADY", 1, hls_in, 13, "axis", "out_acc", 1),
	Port_Property("op_stream_TKEEP", 4, hls_out, 8, "axis", "out_data", 1),
	Port_Property("op_stream_TSTRB", 4, hls_out, 9, "axis", "out_data", 1),
	Port_Property("op_stream_TUSER", 1, hls_out, 10, "axis", "out_data", 1),
	Port_Property("op_stream_TLAST", 1, hls_out, 11, "axis", "out_data", 1),
	Port_Property("op_stream_TID", 1, hls_out, 12, "axis", "out_data", 1),
	Port_Property("op_stream_TDEST", 1, hls_out, 13, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "cv_hw";
