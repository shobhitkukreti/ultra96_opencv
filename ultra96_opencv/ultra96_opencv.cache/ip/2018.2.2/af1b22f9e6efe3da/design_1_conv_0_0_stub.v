...
(* X_CORE_INFO = "conv,Vivado 2018.2.2" *)
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_AXILiteS_AWADDR, 
  ...
  m_axi_CRTL_BUS_AWADDR, m_axi_CRTL_BUS_AWLEN, m_axi_CRTL_BUS_AWSIZE, 
  m_axi_CRTL_BUS_AWBURST, m_axi_CRTL_BUS_AWLOCK, m_axi_CRTL_BUS_AWREGION, 
  m_axi_CRTL_BUS_AWCACHE, m_axi_CRTL_BUS_AWPROT, m_axi_CRTL_BUS_AWQOS, 
  m_axi_CRTL_BUS_AWVALID, m_axi_CRTL_BUS_AWREADY, m_axi_CRTL_BUS_WDATA, 
  m_axi_CRTL_BUS_WSTRB, m_axi_CRTL_BUS_WLAST, m_axi_CRTL_BUS_WVALID, 
  m_axi_CRTL_BUS_WREADY, m_axi_CRTL_BUS_BRESP, m_axi_CRTL_BUS_BVALID, 
  m_axi_CRTL_BUS_BREADY, m_axi_CRTL_BUS_ARADDR, m_axi_CRTL_BUS_ARLEN, 
  m_axi_CRTL_BUS_ARSIZE, m_axi_CRTL_BUS_ARBURST, m_axi_CRTL_BUS_ARLOCK, 
  m_axi_CRTL_BUS_ARREGION, m_axi_CRTL_BUS_ARCACHE, m_axi_CRTL_BUS_ARPROT, 
  m_axi_CRTL_BUS_ARQOS, m_axi_CRTL_BUS_ARVALID, m_axi_CRTL_BUS_ARREADY, 
  m_axi_CRTL_BUS_RDATA, m_axi_CRTL_BUS_RRESP, m_axi_CRTL_BUS_RLAST, 
