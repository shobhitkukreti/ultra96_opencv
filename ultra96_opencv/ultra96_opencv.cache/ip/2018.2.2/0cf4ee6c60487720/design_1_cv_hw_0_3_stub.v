...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_cv_hw_0_3_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, in_stream_V_TVALID, 
  ...
  op_stream_V_TDATA)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,in_stream_V_TVALID,in_stream_V_TREADY,in_stream_V_TDATA[7:0],op_stream_V_TVALID,op_stream_V_TREADY,op_stream_V_TDATA[7:0]" */;
  input ap_clk;
  input ap_rst_n;
